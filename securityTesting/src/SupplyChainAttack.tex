...
These external components are known as dependencies, that are usually managed through package managers (like npm, Maven, pip, etc.).
\\Dependencies can be:
\begin{itemize}
...
\begin{itemize}
    \item \textbf{Source code}: attackers compromise the proprietary code. Usually the credental of developers are needed as well as the access to the repository;
