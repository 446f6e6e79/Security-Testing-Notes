...
If an attacker can insert format specifiers (like \texttt{\%x}, \texttt{\%s}, \texttt{\%n} - format specifiers that pop values from the stack)
into the string, they can read or write arbitrary memory locations.
