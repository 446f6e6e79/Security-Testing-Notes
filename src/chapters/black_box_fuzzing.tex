...
Black-box fuzzing is a fuzzing technique that treats the target program as a "black box", 
focusing on its external behavior without any knowledge of its internal structure or implementation.
...
Since the inputs are randomly generated, it may not be effective in finding specific types of bugs or vulnerabilities.
