...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{../../images/microwave_model.png}
...
\begin{itemize}
    \item Sound approximation: every property that holds in the approximation also holds in the actual program. It may produce false positives but guarantees no false negatives;
