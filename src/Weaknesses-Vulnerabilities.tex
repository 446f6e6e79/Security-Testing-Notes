...
Relates to code and infrastructure that does not protect against integrity violations. An example is the use of \textbf{untrusted CI/CD pipelines}, 
or the use of \textbf{unverified software libraries}. Attackers can exploit these weaknesses to inject malicious code into the application.
\paragraph{Prevention:}
Ensure that all dependencies come from trusted sources, and verify their integrity.

\subsubsection*{Security Logging and Monitoring Failures (A09-2021)}
It relates to the logging and monitoring capability to detect security breaches. You will make yourself vulnerable to information leakage by making logging and alerting events visible to the users.
